...
/**
 * A source of <code>{@link ComponentEvent}(s).</code>
 * @param <E> An observable event
 */
public interface ComponentEventSource<E extends ComponentEvent> {
    /**
     * Adds a listener of events to this event source.
     *
     * @param listener the listener to be added.
     */
    void addListener(final EventListener<E> listener);
     ...
     */
    boolean removeListener(final EventListener<E> listener);
}
