...
public abstract class AbstractDataSecurityPluginTests {
     ...
     */
    protected DataSecurityPlugin plugin;
     ...
     */
    protected abstract DataSecurityPlugin getPlugin();
    ...
    /**
     * Gets a request context for the {@code test} user for the purposes of testing.  Creates a
     * {@link MinimalRequestContext} by default.
     *
     * @return Test attributes
     */
    protected RequestContext getTestContext() {
        return new MinimalRequestContext(getTestJws("test"), "test", getTestUserInfo("test"));
    }
     ...
     * @return User Info
     */
    protected abstract UserInfo getTestUserInfo(String username);
    ...
    public void givenNullLabelsGraph_whenPreparingApplicator_thenDefaultApplicator(byte[] validLabel) {
        // Given and When
        try (SecurityLabelsApplicator applicator = this.plugin.prepareLabelsApplicator(validLabel, null)) {
