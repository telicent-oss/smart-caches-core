...
public class StatusHealthResource extends AbstractHealthResource {
    public static boolean IS_HEALTHY = true;

    public static final List<String> REASONS = new ArrayList<>();
    ...
    protected HealthStatus determineStatus(ServletContext context) {
        return new HealthStatus(IS_HEALTHY, REASONS, Collections.emptyMap());
    }
}
