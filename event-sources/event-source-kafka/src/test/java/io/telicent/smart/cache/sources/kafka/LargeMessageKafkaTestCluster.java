 ...
 * completely insecure cluster which is configured to allow larger messages of up to 6MB.
 * See {@link SecureKafkaTestCluster} or {@link MutualTlsKafkaTestCluster} for secure clusters.
 */
public class LargeMessageKafkaTestCluster extends KafkaTestCluster {
    ...
    protected GenericContainer<?> createKafkaContainer() {
        ...
        return new ConfluentKafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:7.7.1"))
                    .withStartupTimeout(Duration.ofSeconds(30)).withEnv("KAFKA_MESSAGE_MAX_BYTES","6291456");
