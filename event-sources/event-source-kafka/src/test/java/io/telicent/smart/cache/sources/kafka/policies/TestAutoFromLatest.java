...
import io.telicent.smart.cache.sources.kafka.policies.automatic.AutoFromLatest;

public class TestAutoFromLatest extends AbstractReadPolicyTests<String, String> {
    @Override
