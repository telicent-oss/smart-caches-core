...
/**
 * A Kafka deserializer that handles {@link LiveError} messages
 */
public class LiveErrorDeserializer extends AbstractJacksonDeserializer<LiveError> {

    /**
     * Creates a new Live Error deserializer
     */
    public LiveErrorDeserializer() {
        super(LiveError.class);
