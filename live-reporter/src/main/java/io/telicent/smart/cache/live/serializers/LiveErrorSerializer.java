...
/**
 * A Kafka serializer that handles {@link LiveError} values
 */
public class LiveErrorSerializer extends AbstractJacksonSerializer<LiveError> {

    /**
     * Creates a new {@link LiveError} serializer
     */
    public LiveErrorSerializer() {
        super();
