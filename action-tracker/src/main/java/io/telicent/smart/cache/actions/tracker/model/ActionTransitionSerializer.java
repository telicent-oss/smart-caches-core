...
/**
 * A Kafka serializer for {@link ActionTransition} instances
 */
public class ActionTransitionSerializer extends AbstractJacksonSerializer<ActionTransition> {

    /**
     * Creates a new transition serializer
     */
    public ActionTransitionSerializer() {
