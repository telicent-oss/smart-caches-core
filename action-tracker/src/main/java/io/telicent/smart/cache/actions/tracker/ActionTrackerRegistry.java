...
public final class ActionTrackerRegistry {
     ...
     * {@link #setInstance(ActionTracker)} refuses to replace an existing instance.  Leaving a closed
    ...
    public static void reset() {
        if (INSTANCE != null) {
            LOGGER.info("Closing and clearing the configured ActionTracker - {}", INSTANCE);
            INSTANCE.close();
            INSTANCE = null;
        }
    }
