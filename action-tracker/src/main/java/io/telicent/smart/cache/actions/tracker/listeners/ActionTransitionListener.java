...
/**
 * Listener for action state transitions
 */
@FunctionalInterface
public interface ActionTransitionListener {

    /**
     * Called when a {@link SimpleActionTracker} derived tracker transitions between states
     *
     * @param tracker  Tracker instance
     * @param transition Action transition
     */
    void accept(ActionTracker tracker, ActionTransition transition);
}
